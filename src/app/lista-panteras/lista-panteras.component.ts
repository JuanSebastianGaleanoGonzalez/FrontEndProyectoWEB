...
@Component({
  selector: 'app-lista-panteras',
  templateUrl: './lista-panteras.component.html',
  styleUrls: ['./lista-panteras.component.css']
})
export class ListaPanterasComponent implements OnInit {
